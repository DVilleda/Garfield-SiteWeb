<?php
	...
	class Fiction extends  Controleur {
		...
		public function executerAction() {
			...
			if($valide){
				if($this->getActeur() == "usager"){
					$comment = new Commentaire(4,$_POST['comment'],$_SESSION['usagerConnecte']);
					CommentaireDAO::inserer($comment);
				}else if($this->getActeur() == "administrateur"){
					$comment = new Commentaire(4,$_POST['comment'],$_SESSION['adminConnecte']);
					CommentaireDAO::inserer($comment);
				}
			}
			return "pageFiction";
